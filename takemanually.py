...
def manually_fill():
    ...
    sb.title("Enter dept name...")
    sb.geometry("580x320")
    sb.configure(background="snow")

    def err_screen_for_dept():
        def ec_delete():
            ec.destroy()
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            def err_screen1():
                ...
                tk.Label(
                    errsc2,
                    text="Please enter person & Enrollment!!!",
                    fg="red",
                    bg="white",
                    font=("times", 16, " bold "),
                ).pack()
            ...
            PERSON_ENTRY.place(x=290, y=205)

            def remove_person():
                PERSON_ENTRY.delete(first=0, last=22)
            ...
            def enter_data_DB():
                ...
                if ENROLLMENT == "":
                    ...
                    if index == 0:
                        d = {
                            index: {"Enrollment": ENROLLMENT, "Name": PERSON, Date: 1}
                        }
                        index += 1
                        ENR_ENTRY.delete(0, "end")
                        PERSON_ENTRY.delete(0, "end")
                    else:
                        d[index] = {"Enrollment": ENROLLMENT, "Name": PERSON, Date: 1}
                        index += 1
                        ENR_ENTRY.delete(0, "end")
                        PERSON_ENTRY.delete(0, "end")
            ...
            c1ear_person.place(x=690, y=200)
