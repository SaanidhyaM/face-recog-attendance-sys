...
trainimagelabel_path = (
    r"C:\Users\saani\Downloads\face-recog\face-recog\TrainingImageLabel\Trainner.yml"
)
trainimage_path = r"C:\Users\saani\Downloads\face-recog\face-recog\TrainingImage"
...
logo = Image.open(r"C:\Users\saani\Downloads\face-recog\face-recog\UI_Image\0001.png")
...
titl = tk.Label(
    window, text="Robolabs AI", bg="#1c1c1c", fg="yellow", font=("Verdana", 27, "bold"),
)
titl.place(x=525, y=12)

a = tk.Label(
    window,
    text="Attendance Program",
...
ri = Image.open(r"C:\Users\saani\Downloads\face-recog\face-recog\UI_Image\register.png")
r = ImageTk.PhotoImage(ri)
label1 = Label(window, image=r)
label1.image = r
label1.place(x=100, y=270)

ai = Image.open(r"C:\Users\saani\Downloads\face-recog\face-recog\UI_Image\attendance.png")
a = ImageTk.PhotoImage(ai)
label2 = Label(window, image=a)
label2.image = a
label2.place(x=980, y=270)

vi = Image.open(r"C:\Users\saani\Downloads\face-recog\face-recog\UI_Image\verifyy.png")
...
def automatic_attedance():
    automaticAttedance.deptChoose(text_to_speech)
...
def view_attendance():
    show_attendance.deptchoose(text_to_speech)
